...
impl Pride {
    ...
    pub fn draw(&mut self, leds: &mut [RGB8]) {
        ...
        for i in 0..num_leds {
            ...
            let b16 = sin16(brightnesstheta16) + 32768;

            // uint16_t bri16 = (uint32_t)((uint32_t)b16 * (uint32_t)b16) / 65536;
            // let bri16 = (((b16 as u32) * (b16 as u32)) / 65536) as u16;

            // uint8_t bri8 = (uint32_t)(((uint32_t)bri16) * brightdepth) / 65536;
            let mut bri8 = (((b16 as u32) * (brightdepth as u32)) / 65536) as u8;
