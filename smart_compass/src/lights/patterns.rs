...
impl Pattern for Pride {
    ...
    fn draw(&mut self, leds: &mut [RGB8]) {
        ...
        for i in COORDS_X.iter().cloned() {
            ...
            let new_color = Hsv { hue: hue8, sat: sat8, val: bri8 };
